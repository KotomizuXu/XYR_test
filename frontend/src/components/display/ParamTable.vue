...
<template>
  <n-card title="参数建议" size="small">
    <n-descriptions bordered :column="1">
      <n-descriptions-item label="风格">{{ data.style_name }}</n-descriptions-item>
      <n-descriptions-item label="推荐章数">{{ data.rec_chapters }}</n-descriptions-item>
